    ...
    Office.initialize = function () {
        $(document).ready(function () {
            if (Office.context.requirements.isSetSupported('WordApi', '1.1')) {
                ...
                //document.getElementById("emerson").onclick = insertEmersonQuoteAtSelection;
                //document.getElementById("checkhov").onclick = insertChekhovQuoteAtTheBeginning;
                //document.getElementById("proverb").onclick = insertChineseProverbAtTheEnd;
